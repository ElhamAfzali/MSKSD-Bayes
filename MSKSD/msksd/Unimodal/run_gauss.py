...
#     colors = ['#0072B2', '#D55E00', '#009E73', '#CC79A7', '#E69F00', '#56B4E9']  # More modern and visually distinct colors
#     styles = ['-', '--', ':']
...
#     axs[0, 2].legend(handles, labels , loc='upper right', fontsize=12, frameon=True)
#     axs[1, 2].legend(handles2, labels2 , loc='upper right', fontsize=12, frameon=True)
#
#
#     plt.tight_layout(pad=0.8, h_pad=0.5, w_pad=0.5, rect=[0.02, 0.02, 0.98, 0.98])
#     save_path = f"experiment_results_plot_weight_factor_{weight_factor}.pdf"
#     plt.savefig(save_path, dpi=600, bbox_inches="tight", format='pdf')  # High-resolution PDF
